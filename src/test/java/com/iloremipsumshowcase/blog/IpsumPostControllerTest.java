...
@BeforeEach
    ...
    String redirect = underTest.addIpsumPost("Test Ipsum","this is a test blog post","Test sample", "test source", "testpic",null, testIpsumCategory.getCategoryName(),testAuthor.getAuthorName());
...
@Test
   ...
   when(mockIpsumCategoryRepo.findByCategoryName(testIpsumCategory.getCategoryName())).thenReturn(testIpsumCategory);
    ...
    underTest.addIpsumPost("Test Ipsum", "this is a test blog post", "Test sample", "test source", "testpic",null,testIpsumCategory.getCategoryName(),testAuthor.getAuthorName());
